...
import { Lock, Phone, ArrowRight, UserCheck } from 'lucide-react';
    ...
    <div className="py-12 max-w-md mx-auto px-4 sm:px-6">
      <div className="bg-white p-8 rounded-3xl border border-slate-200/80 shadow-xl space-y-6">
        <div className="text-center space-y-2">
          ...
          <h1 className="text-2xl font-extrabold text-slate-900 tracking-tight">Customer Login</h1>
          <p className="text-xs text-slate-500">Sign in to view your orders & saved addresses</p>
        </div>
        ...
        <div className="pt-4 border-t border-slate-100 text-center text-xs text-slate-500">
          ...
          <Link href="/account/register" className="font-bold text-rose-600 hover:underline">
            Register Here
          </Link>
        </div>
      </div>
